...
function Thesis() {
  ...
  const handleSubmit = async () => {
    ...
    await fetch(`${SERVER}/home/inserting`, {
      method: "POST",
      body: formDataToSend,
    })
  ...
  <main className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-md mt-5">
    <h1 className="text-3xl font-semibold text-center text-gray-800">Thesis Incentive</h1>
    ...
    {storedUserData === null ? (
      ...
      <div className="bg-white p-4 rounded-md shadow-md mb-6">
        ...
        {/* Form Section */}
        <h2 className="text-xl font-semibold mt-6">Thesis Details</h2>
