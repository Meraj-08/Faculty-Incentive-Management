...
function Colloqium() {
  ...
  <main className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-md mt-5">
    <h1 className="text-3xl font-semibold text-center text-gray-800">Colloquium Incentive</h1>
    ...
    {storedUserData === null ? (
      ...
      <div className="bg-white p-4 rounded-md shadow-md mb-6">
        ...
        {/* Form Section */}
        <h2 className="text-xl font-semibold mt-6">Colloquium Details</h2>
            ...
            {results.length > 0 ? (
              results.map((result) => (
                <tr key={result._id} className="border-b border-gray-200">
                  ...
                  <td className="border border-gray-300 p-2">{result.hasapproved}</td>
                </tr>
              ))
            ) : (
              <tr>
